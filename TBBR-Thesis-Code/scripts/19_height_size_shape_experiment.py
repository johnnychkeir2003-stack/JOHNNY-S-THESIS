...
OUTPUT_DIR = os.path.join(BASE_DIR, "working", "height_size_shape_experiment")
os.makedirs(OUTPUT_DIR, exist_ok=True)

CSV_PATH = os.path.join(BASE_DIR, f"working\\height_size_shape_experiment\\{SPLIT}_height_size_shape_experiment.csv")

# -------------------------
# PARAMETERS
# -------------------------
HEIGHT_PERCENTILES = [40, 50, 60]
MIN_COMPONENT_AREAS = [10, 30, 50]
MIN_ELONGATIONS = [1.2, 1.5, 2.0, 3.0]
...
def filter_by_size_and_shape(comps, min_area, min_elongation):
    filtered = []
...
for height_percentile in HEIGHT_PERCENTILES:
    for min_area in MIN_COMPONENT_AREAS:
        for min_elongation in MIN_ELONGATIONS:
            total_annotations = 0
            total_retained = 0
            total_missed = 0
            ...
            for img_info in images:
                ...
                filtered_comps = filter_by_size_and_shape(comps, min_area, min_elongation)
            ...
            results.append({
                ...
                "components_before_filter": total_components_before,
                "components_after_filter": total_components_after,
