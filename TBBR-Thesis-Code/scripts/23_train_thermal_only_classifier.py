...
MODEL_OUTPUT = "working/models/thermal_only_logreg.pkl"
METRICS_OUTPUT = "working/results/thermal_only_metrics.csv"
RANDOM_STATE = 42
TEST_SIZE = 0.2

# Thermal-only feature set
FEATURE_COLUMNS = [
    "thermal_mean",
    "thermal_max",
    "thermal_min",
...
metrics_df = pd.DataFrame([{
    "model": "thermal_only_logistic_regression",
    "rows_total": len(df),
