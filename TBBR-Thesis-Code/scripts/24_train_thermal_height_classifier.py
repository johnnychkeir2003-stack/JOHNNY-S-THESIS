...
MODEL_OUTPUT = "working/models/thermal_height_logreg.pkl"
METRICS_OUTPUT = "working/results/thermal_height_metrics.csv"
RANDOM_STATE = 42
TEST_SIZE = 0.2
...
print("=== THERMAL + HEIGHT CLASSIFIER ===")
...
metrics_df = pd.DataFrame([{
    "model": "thermal_height_logistic_regression",
    "rows_total": len(df),
