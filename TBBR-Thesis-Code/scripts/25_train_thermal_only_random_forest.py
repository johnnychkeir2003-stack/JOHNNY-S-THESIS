...
MODEL_OUTPUT = "working/models/thermal_only_rf.pkl"
METRICS_OUTPUT = "working/results/thermal_only_rf_metrics.csv"
RANDOM_STATE = 42
TEST_SIZE = 0.2
...
print("=== THERMAL-ONLY RANDOM FOREST ===")
...
metrics_df = pd.DataFrame([{
    "model": "thermal_only_random_forest",
    "rows_total": len(df),
